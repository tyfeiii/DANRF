...
class ct_dataset(Dataset):
    def __init__(self, mode, load_mode, saved_path, test_patient, patch_n=None, patch_size=None, transform=None, genlabel = None):
    ...
    def __getitem__(self, idx):
        ...
        if self.patch_size and not (str(self.genlabel) in input_imgn):
...
def get_loader(mode='train', load_mode=0,
    ...
    return data_loader
#shuffle when training, no shuffle when testing